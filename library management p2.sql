...
select m.member_id, m.member_name, count(i.issued_id) as total  from
members m join issued_status i
...
select b.book_title, count(i.issued_book_name) as total_books from books b join issued_status i
...
select e.emp_name,b.manager,b.branch_address,b.contact_no from
employees e join branch b 
...
create table certain_tresh
as
(
select * from books
where rental_price >= 2.3
) 
select * from certain_tresh
-- Task 12: Retrieve the List of Books Not Yet Returned
select
     distinct i.issued_book_name
	 from issued_status i left join return_status r
